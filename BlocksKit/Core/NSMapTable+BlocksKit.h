 ...
 */
- (NSMapTable<KeyType, ObjectType> *)bk_select:(BOOL (^)(KeyType key, ObjectType obj))block;
 ...
 */
- (NSMapTable<KeyType, ObjectType> *)bk_reject:(BOOL (^)(KeyType key, ObjectType obj))block;
